# GP24_PredictingStockPrices guide installation
...
activate gp24_predictingstockprices
```
...
To move beyond notebook prototyping, all reusable code should go into the `gp24package/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `gp24package` folder and use the modules inside your notebooks :
...
```python
from gp24package.utils.paths import data_dir
data_dir()
```
